    ...
    public static void main(String[] args) throws Exception{
        ...
        Authenticator authenticator = new Authenticator() {
            ...
            public PasswordAuthentication getPasswordAuthentication() {
                ...
                return new PasswordAuthentication("wxdonger1@163.com","wangxiaodong21");
            }
        };
        ...
        message.setFrom(new InternetAddress("wxdonger1@163.com"));
        /**
         * 2.2 收件人
         *         第一个参数：
         ...
         *         这里我们发送给我们的qq邮箱
         */
        message.setRecipient(RecipientType.TO, new InternetAddress("jayc3@qq.com"));
        // 2.3 主题（标题）
